 ...
 <tr><td>类别</td><td>详情</td><td>时间</td></tr>
	...
	%>
 	...
 	<% 
        ...
        <ul id="page">
        <li><a href="/wantServlet?thisPage=${requestScope.thisPage-1}">上一页</a></li>
        ...
        <li><a <%if(thisPage==i){out.print("id='thisPage'");}%> href="/wantServlet?thisPage=<%out.print(i);%>"><%out.print(i);%></a></li>
        <%}%>
        <%if(pageNum%10>0&&pageNum/10>(thisPage-1)/10){out.print("<a href='/wantServlet?thisPage="+((((thisPage-1)/10)+1)*10+1)+"'>&gt;&gt;</a>");}%>
